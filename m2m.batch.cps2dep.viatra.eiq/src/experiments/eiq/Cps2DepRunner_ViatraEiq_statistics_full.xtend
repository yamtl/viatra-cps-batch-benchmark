...
class Cps2DepRunner_ViatraEiq_statistics_full extends FullBenchmarkRunner {
	var CPS2DeploymentBatchTransformationEiq xform 
    var CPSToDeployment cps2dep
    
	override getIdentifier() {
		"cps2dep_statistics_viatraEiq"
	}
...
//		#[1]
	...
	def static void main(String[] args) {
		val runner = new Cps2DepRunner_ViatraEiq_statistics_full
...
//		var String outputModelPath = '''../m2m.batch.data/cps2dep/clientServer/deployment/viatra'''
		var String inputModelPath = '''../m2m.batch.data/cps2dep/statistics'''
		var String outputModelPath = '''../m2m.batch.data/cps2dep/statistics/deployment/viatra'''
