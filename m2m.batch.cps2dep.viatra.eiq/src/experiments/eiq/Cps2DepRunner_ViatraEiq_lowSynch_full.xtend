...
class Cps2DepRunner_ViatraEiq_lowSynch_full extends FullBenchmarkRunner {
	var CPS2DeploymentBatchTransformationEiq xform 
    var CPSToDeployment cps2dep
    
	override getIdentifier() {
		"cps2dep_lowSynch_viatraEiq"
	}
...
//		#[1]
	...
	def static void main(String[] args) {
		val runner = new Cps2DepRunner_ViatraEiq_lowSynch_full
...
//		var String outputModelPath = '''../m2m.batch.data/cps2dep/clientServer/deployment/viatra'''
		var String inputModelPath = '''../m2m.batch.data/cps2dep/lowSynch'''
		var String outputModelPath = '''../m2m.batch.data/cps2dep/lowSynch/deployment/viatra'''
