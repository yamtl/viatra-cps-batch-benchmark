...
class Cps2DepRunner_emftvm_full_publishSubscribe extends FullBenchmarkRunner {
	var ExecEnv env
	var ResourceSet rs
	var TimingData td 
	var Model outModel 
...
//		"cps2dep_clientServer_atl2010"
		"cps2dep_publishSubscribe_emftvm"
	}
...
//		#[1, 8192]
	...
	def static void main(String[] args) {
		...
		val runner = new Cps2DepRunner_emftvm_full_publishSubscribe
