...
class Cps2Dep_ClientServer_XtendOptimizedRunner_full extends FullBenchmarkRunner {

	var CPS2DeploymentBatchTransformationOptimized xform 
    var CPSToDeployment cps2dep
    
	override getIdentifier() {
		"cps2dep_clientServer_xtend_optimized"
	}
...
//		#[1, 1, 8, 16, 32, 64, 128, 256, 512, 1024, 2048, 4096, 8192, 16384]
	...
	def static void main(String[] args) {
		...
		val runner = new Cps2Dep_ClientServer_XtendOptimizedRunner_full
	...
	override doLoad(String iteration) {
		...
		var String outputModelPath = '''../m2m.batch.data/cps2dep/clientServer/deployment/xtendOptimized'''
