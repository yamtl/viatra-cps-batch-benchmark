...
class Cps2Dep_PublishSubscribe_XtendBatchRunner_full extends FullBenchmarkRunner {

	var CPS2DeploymentBatchTransformationSimple xform 
    var CPSToDeployment cps2dep
    
	override getIdentifier() {
		"cps2dep_publishSubscribe_xtend_simple"
	}
...
//		#[1]
	...
	def static void main(String[] args) {
		...
		val runner = new Cps2Dep_PublishSubscribe_XtendBatchRunner_full
	...
	override doLoad(String iteration) {
		...
		var String outputModelPath = '''../m2m.batch.data/cps2dep/publishSubscribe/deployment/xtendSimple'''
